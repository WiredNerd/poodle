...
# from poodle.common.echo_wrapper import EchoWrapper, PoodleWork, logger
...
#         assert work.echo == work._echo_wrapper.secho
...
#         file = mock.MagicMock()
#         wrap.secho("test", file=file, nl=False, err=True, fg="black")
